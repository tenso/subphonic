...
GCeil::GCeil(BitmapFont* f, GroundMixer& g) : SoundComp(g)
{
...
Value** GCeil::getOutput(unsigned int id)
{
    return (Value**)&sig;
}

void GCeil::addInput(Value** out, unsigned int fromid)
{
    sig->setInput(out);

}

void GCeil::remInput(Value** out, unsigned int fromid)
{
    sig->setInput(NULL);
} 
...
/*
  void GCeil::getState(SoundCompEvent* e)
  {
  }

  void GCeil::setState(SoundCompEvent* e)
  {
  DASSERT(e!=NULL);
  }
*/
